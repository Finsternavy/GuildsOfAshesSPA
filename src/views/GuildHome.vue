...
.guild-banner-test {
  ...
  z-index: 2!important;
  clip-path: polygon(0% 0%, 100% 0%, 100% 100%, 98% 98%, 97% 98%, 96% 98%, 94% 99%, 92% 98%, 92% 97%, 90% 99%, 88% 100%, 87% 99%, 85% 100%, 83% 99%, 81% 99%, 79% 99%, 77% 100%, 74% 100%, 72% 99%, 68% 99%, 66% 97%, 65% 100%, 63% 99%, 61% 100%, 58% 100%, 52% 100%, 47% 99%, 46% 97%, 43% 99%, 42% 98%, 40% 100%, 37% 99%, 34% 100%, 31% 99%, 27% 100%, 18% 100%, 17% 97%, 16% 100%, 14% 99%, 13% 100%, 11% 99%, 10% 100%, 5% 100%, 4% 99%, 2% 100%, 0% 100%);
  /* overflow: hidden; */
}
