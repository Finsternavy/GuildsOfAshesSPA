...
<template>
  <div id="PrimaryLayout"
        ...
        :data-src="imagePrefix + randomImage()" 
    ...
    <section id="GlobalFooter" class="uk-section goa-container-no-radius uk-margin-large-top uk-section-xsmall uk-padding-remove">
      <!-- <footer-navigation /> -->
